    ...
    <main class="flex-1 overflow-y-auto p-6 bg-gray-50 dark:bg-gray-900">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            ...
            <div class="bg-white p-6 rounded-xl shadow dark:bg-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-gray-500 dark:text-gray-400">Exemple de donnée</p>
        ...
        <div class="bg-white p-6 rounded-xl shadow dark:bg-gray-800">
            <div class="text-center py-12">
                ...
                <h3 class="text-lg font-medium text-gray-500 dark:text-gray-400">Votre contenu ici</h3>
