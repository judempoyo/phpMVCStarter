...
<body class="bg-zinc-200 dark:bg-zinc-900 text-zinc-900 dark:text-white ">
    ...
    <button onclick="toggleTheme()" class="fixed self-end p-2 text-white bg-zinc-600 rounded-full top-2 md:top-10 right-3 md:right-20 hover:bg-zinc-700 transition-transform transform hover:scale-110">
